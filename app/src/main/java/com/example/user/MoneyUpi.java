...
public class MoneyUpi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_money_upi);
    ...
    void payUsingUpi(  String name,String upiId, String amount) {
        ...
        if(null != chooser.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(MoneyUpi.this,"No UPI app found, please install one to continue",Toast.LENGTH_SHORT).show();
        }
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(MoneyUpi.this)) {
            ...
            if (status.equals("success")) {
                ...
                Toast.makeText(MoneyUpi.this, "Transaction failed.Please try again", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(MoneyUpi.this, "Internet connection is not available. Please check and try again", Toast.LENGTH_SHORT).show();
        }
    }
